...
class MenusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'parent_id_1' => ['type' => 'integer', 'length' => 10, 'default' => null, 'null' => false, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'sistemas_menus_fk' => ['type' => 'foreign', 'columns' => ['sistema_id'], 'references' => ['sistemas', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
