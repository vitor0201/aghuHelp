...
app.controller('productsCtrl', function($scope, $http) {
    ...
    function getResultsPage(pageNumber) {
        ...
        $http.get('index.json?page=' + pageNumber)
            .then(function(result) {
                console.log(result);
                $scope.users = result.data.usuarios;
                $scope.totalUsers = result.data.paging.Usuarios.count;
            });
    }
		...
		<div class="col s12">
			...
			<table class="hoverable bordered">
				...
				<tbody >
					...
					<tr dir-paginate="d in users | itemsPerPage: usersPerPage" total-items="totalUsers" current-page="pagination.current">
