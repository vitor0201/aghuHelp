        ...
        <div id="loader" ></div> 
            <table class="table table-hover" cellpadding="0" cellspacing="0">
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                                                <td><?php echo $this->Number->format($sistema->id) ?></td>
                                                <td><?php echo h($sistema->nome) ?></td>
                                                <td><?php echo h($sistema->ativo) ?></td>
                                                <td><?php echo h($sistema->criado_em) ?></td>
                                                <td><?php echo h($sistema->atualizado_em) ?></td>
                                                <td><?php echo h($sistema->versao) ?></td>
                                                <td>
                        <!-- 
                            <div class="dropdown pull-right">
                             ...
                             -->
                            <a href="#" class="btn btn-info btn-sm pull-right"  rel="popover" data-placement="left" data-popover-content="#myPopover<?php echo $sistema->id ?>" data-container="body" data-toggle="popover"> <span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a>
