...
<div id="AjaxContent"
	class="categorias index large-9 medium-8 columns content"> 
<?php //echo date('d/m/Y H:i:s') ; ?>
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			...
			<h3><?php echo __('Categorias') ?> <small>Listagem</small>
			</h3>
		</div>
			...
			<div id="PanelBody">
				...
				<table class="table table-striped" cellpadding="0" cellspacing="0"
                    ...
                    <tr <?php echo $class;?>>
							<td class="action">
								...
								<div class="btn-group ">
									...
									<ul class="dropdown-menu ">
										<li><?php echo $this->Html->link(__('Detalhes'), ['action' => 'view', $categoria->id], ['escape' => false]); ?></li>
										<li><?php echo $this->Html->link(__('Alterar'), ['action' => 'edit', $categoria->id], ['escape' => false]); ?></li>
							...
							<td data-title="descricao"><?php echo h($categoria->descricao) ?>&nbsp;</td>
							<td data-title="ativo"><?php echo $categoria->ativo ? $this->Html->label('ATIVO','info') : $this->Html->label('INATIVO','danger') ?>&nbsp;</td>

							<!-- 
                        <td>
                            <a href="#" class="btn btn-info btn-sm pull-right"  rel="popover" data-placement="left" data-popover-content="#myPopover<?php echo $categoria->id ?>" data-container="body" data-toggle="popover"> <span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a>
							<div id="myPopover<?php echo $categoria->id ?>" class="hide">
								  <?php echo $this->Html->link('<span class="glyphicon glyphicon-info-sign " aria-hidden="true"></span>', ['action' => 'view', $categoria->id], ['class'=>'btn btn-default', 'escape' => false])?>
                                  <?php
                        
                        echo $this->Html->link('<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>', [
                            'action' => 'edit',
                            $categoria->id
                        ], [
                            ...
                            escape => false
                             ...
                             <?php
                             echo $this->Html->link('<span class="glyphicon glyphicon-trash " aria-hidden="true"></span>', [
                            'action' => 'delete',
                            $categoria->id
                        ]
                        , [
              ...
              <?php if($categorias->isEmpty()  && !empty($url) ):?>
