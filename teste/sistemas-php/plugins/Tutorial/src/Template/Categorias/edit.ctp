<div class="panel panel-default categorias">
	<div class="panel-heading">
		<div class="dropdown pull-right">
			...
			<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
				...
				<li> <?php echo $this->Html->link('<span class="glyphicon glyphicon-info-sign pull-right" aria-hidden="true"></span>&nbsp; '.__('Detalhes'), ['action' => 'view', $categoria->id], ['escape' => false]) ?></li>
		...
		<h3>
			Categorias <small> Alterar </small>
		</h3>
	</div>
