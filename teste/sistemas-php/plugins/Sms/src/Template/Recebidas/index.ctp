...
<div id="AjaxContent" class="recebidas index large-9 medium-8 columns content"> 
           ...
           // $this->Form->templates($CustomConfig['FormFilter.Template']);            
            ...
            <div class="panel-body">                
            	<?php echo $this->Form->input('filtro1') ?>
                                ...
                                <?php echo $this->Form->input('data_hora') ?>
                            </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
             <div class="dropdown pull-right">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuTop">
                                    <li> <?php echo $this->Html->link('<span class="glyphicon glyphicon-plus pull-right" aria-hidden="true"></span>&nbsp; '.__('Novo Recebida'), ['action' => 'add'], ['escape' => false]) ?></li>
                                </ul>
                </div>
            <h3><?php echo __('Recebidas') ?> <small>Listagem</small></h3>
        </div>
        ...
        <div id="PanelBody" >  
            ...
            <table class="table table-striped" cellpadding="0" cellspacing="0" style="margin: 0; padding: 0">
                <thead>
                    <tr>
                    	<th class="actions">&nbsp;</th>
                                                ...
                                                <th class="ajax-pagination"><?php echo $this->Paginator->sort('fone') ?></th>
                                                <th class="ajax-pagination"><?php echo $this->Paginator->sort('texto') ?></th>
                                                <th class="ajax-pagination"><?php echo $this->Paginator->sort('data_hora') ?></th>
                    ...
                    <tr <?php echo $class;?>>
                    		...
                    		<div class="btn-group ">
									 ...
									 <ul class="dropdown-menu ">
									    <li><?php echo $this->Html->link(__('Detalhes'), ['action' => 'view', $recebida->id], ['escape' => false]); ?></li>
									    <li><?php echo $this->Html->link(__('Alterar'), ['action' => 'edit', $recebida->id], ['escape' => false]); ?></li>
									   
									    <li role="separator" class="divider"></li>
									    <li><?php echo $this->Html->link(__('Remover'), ['action' => 'delete', $recebida->id], ['class'=>'delete-confirm','escape' => false]) ?></li>
									  </ul>
							</div>
						</td>
                                                <td data-title="id"><?php echo $this->Number->format($recebida->id) ?>&nbsp;</td>
                                                <td data-title="fone"><?php echo h($recebida->fone) ?>&nbsp;</td>
                                                <td data-title="texto"><?php echo h($recebida->texto) ?>&nbsp;</td>
                                                <td data-title="data_hora"><?php echo h($recebida->data_hora) ?>&nbsp;</td>
                                                 
                        <!-- 
                        <td>
                            <a href="#" class="btn btn-info btn-sm pull-right"  rel="popover" data-placement="left" data-popover-content="#myPopover<?php echo $recebida->id ?>" data-container="body" data-toggle="popover"> <span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a>
							<div id="myPopover<?php echo $recebida->id ?>" class="hide">
								  <?php echo $this->Html->link('<span class="glyphicon glyphicon-info-sign " aria-hidden="true"></span>', ['action' => 'view', $recebida->id], ['class'=>'btn btn-default', 'escape' => false]) ?>
                                   <?php echo $this->Html->link('<span class="glyphicon glyphicon-pencil " aria-hidden="true"></span>', ['action' => 'edit', $recebida->id], ['class'=>'btn btn-default','escape' => false]) ?>
                                  <?php echo $this->Html->link('<span class="glyphicon glyphicon-trash " aria-hidden="true"></span>', ['action' => 'delete', $recebida->id], ['class'=>'btn btn-danger delete-confirm','title'=>"Remover",'escape' => false]) ?>
							</div>
                        </td>
                         -->
                    </tr>
              ...
              <?php if($recebidas->isEmpty()  && !empty($url) ):?>
