...
use Wifi\Model\Table\SituacoesTable;

/**
 * Wifi\Model\Table\SituacoesTable Test Case
 */
class SituacoesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Situacoes') ? [] : ['className' => 'Wifi\Model\Table\SituacoesTable'];
