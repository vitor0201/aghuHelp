...
<div id="AjaxContent" class="redes index large-9 medium-8 columns content"> 
        ...
        <div id="collapseOne" class="panel-collapse collapse ">
           ...
           // $this->Form->templates($CustomConfig['FormFilter.Template']);            
            ...
            <div class="panel-body">                
                                ...
                                <?php echo $this->Form->input('ativo', ['options'=>[0=>'Inativo','Ativo'],'empty'=>'Todos']) ?>
                            </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
             <div class="dropdown pull-right">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuTop">
                                    <li> <?php echo $this->Html->link('<span class="glyphicon glyphicon-plus pull-right" aria-hidden="true"></span>&nbsp; '.__('Novo Rede'), ['action' => 'add'], ['escape' => false]) ?></li>
                                </ul>
                </div>
            <h3><?php echo __('Redes') ?> <small>Listagem</small></h3>
        </div>
        ...
        <div id="PanelBody" >  
            ...
            <table class="table table-striped" cellpadding="0" cellspacing="0" style="margin: 0; padding: 0">
                <thead>
                    <tr>
                    	<th class="actions">&nbsp;</th>
                                                ...
                                                <th class="ajax-pagination"><?php echo $this->Paginator->sort('faixa_ip') ?></th>
                                                <th class="ajax-pagination">QTD</th>
                    ...
                    <tr <?php echo $class;?>>
                    		...
                    		<div class="btn-group ">
									 ...
									 <ul class="dropdown-menu ">
									    <li><?php echo $this->Html->link(__('Detalhes'), ['action' => 'view', $rede->id], ['escape' => false]); ?></li>
									    <li><?php echo $this->Html->link(__('Alterar'), ['action' => 'edit', $rede->id], ['escape' => false]); ?></li>
									   
									    <li role="separator" class="divider"></li>
									    <li><?php echo $this->Html->link(__('Remover'), ['action' => 'delete', $rede->id], ['class'=>'delete-confirm','escape' => false]) ?></li>
									  </ul>
							</div>
						</td>
                                               
                                                <td data-title="Nome"><?php echo h($rede->nome) ?>&nbsp;</td>
                                                <td data-title="Faixa IP"><?php echo h($rede->faixa_ip) ?>&nbsp;</td>
                                                 <td data-title="Quantidade"><?php echo count($rede->dispositivos) ?>&nbsp;</td>
                                             
                                                <td data-title="Ativo"><?php echo ($rede->ativo ? $this->Html->label('ATIVO','info') :  $this->Html->label('INATIVO','danger') ) ?>&nbsp;</td>
                                                 
                        <!-- 
                        <td>
                            <a href="#" class="btn btn-info btn-sm pull-right"  rel="popover" data-placement="left" data-popover-content="#myPopover<?php echo $rede->id ?>" data-container="body" data-toggle="popover"> <span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a>
							<div id="myPopover<?php echo $rede->id ?>" class="hide">
								  <?php echo $this->Html->link('<span class="glyphicon glyphicon-info-sign " aria-hidden="true"></span>', ['action' => 'view', $rede->id], ['class'=>'btn btn-default', 'escape' => false]) ?>
                                   <?php echo $this->Html->link('<span class="glyphicon glyphicon-pencil " aria-hidden="true"></span>', ['action' => 'edit', $rede->id], ['class'=>'btn btn-default','escape' => false]) ?>
                                  <?php echo $this->Html->link('<span class="glyphicon glyphicon-trash " aria-hidden="true"></span>', ['action' => 'delete', $rede->id], ['class'=>'btn btn-danger delete-confirm','title'=>"Remover",'escape' => false]) ?>
							</div>
                        </td>
                         -->
                    </tr>
              ...
              <?php if($redes->isEmpty()  && !empty($url) ):?>
                    ...
                    <ul class="pagination  pagination-sm">
                     ...
                     <div class="btn-group pagination hidden-xs hidden-sm dropup">
									  ...
									  <button type="button" class="btn  btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									    <?php echo $active? $active : 50;?> / pág. <span class="caret"></span>
									  </button>
