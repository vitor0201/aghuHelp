<div class="panel panel-default dispositivos">
			...
			<div class="dropdown pull-right">
				...
				<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
					<li> <?php echo $this->Html->link('<span class="glyphicon glyphicon-list pull-right" aria-hidden="true"></span>&nbsp; '.__('Listagem'), ['action' => 'index'], ['escape' => false]) ?></li>
										...
										<li> <?php echo $this->Html->link('<span class="glyphicon glyphicon-info-sign pull-right" aria-hidden="true"></span>&nbsp; '.__('Detalhes'), ['action' => 'view', $dispositivo->id], ['escape' => false]) ?></li>
   ...
   <div class="panel-body" style="position:relative;">  
       ...
       // debug($dispositivo);
            ...
            echo $this->Form->input('internauta_id', ['help'=>$dispositivo->internauta->nome." - ".$dispositivo->internauta->login,'options' => $internautas,'class'=>'select2','empty'=>'--- Escolha ---']);
...
// 			echo $this->Form->input('endereco_ip', ['label'=> 'IP', 'options'=>$ips,'class'=>'select2']);
// 			echo $this->Form->input('interface', ['label'=> 'Interface']);

			echo $this->Form->input('descricao', ['label'=>'Descrição']);
			echo $this->Form->input('rede_id', ['label'=> 'Interface/Rede', 'options'=>$redes,'empty'=>'-------','onchange'=>'realoadIP(this)']);
			echo $this->Form->input('endereco_ip', ['id'=>'EnderecoIPId','label'=> 'IP', 'options'=>$ips, 'class'=>'select2']);
   ...
   <div class="panel-footer"> 
              ...
              &nbsp;&nbsp; <input type="checkbox" name="enviar_email"  value=1 ><small> Enviar e-mail ao usuário.</small>
