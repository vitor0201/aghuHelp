...
<div id="AjaxContent" class="coletas index large-9 medium-8 columns content"> 
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
             <div class="dropdown pull-right">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuTop">
                                    <li> <?php echo $this->Html->link('<span class="glyphicon glyphicon-plus pull-right" aria-hidden="true"></span>&nbsp; '.__('Novo Coleta'), ['action' => 'add'], ['escape' => false]) ?></li>
                                </ul>
                </div>
            <h3><?php echo __('Coletas') ?> <small>Listagem</small></h3>
        </div>
        ...
        <div id="PanelBody" >  
            ...
            <table class="table table-striped" cellpadding="0" cellspacing="0" style="margin: 0; padding: 0">
                <thead>
                    <tr>
                    	<th class="actions">&nbsp;</th>
                                                ...
                                                <th class="ajax-pagination"><?php echo $this->Paginator->sort('codigo') ?></th>
                                                <th class="ajax-pagination"><?php echo $this->Paginator->sort('descricao') ?></th>
                                                <th class="ajax-pagination"><?php echo $this->Paginator->sort('validate') ?></th>
                                                <th class="ajax-pagination"><?php echo $this->Paginator->sort('lote') ?></th>
                                                <th class="ajax-pagination"><?php echo $this->Paginator->sort('quantidade') ?></th>
                    ...
                    <tr <?php echo $class;?>>
                    		...
                    		<div class="btn-group ">
									 ...
									 <ul class="dropdown-menu ">
									    <li><?php echo $this->Html->link(__('Detalhes'), ['action' => 'view', $coleta->id], ['escape' => false]); ?></li>
									    <li><?php echo $this->Html->link(__('Alterar'), ['action' => 'edit', $coleta->id], ['escape' => false]); ?></li>
									   
									    <li role="separator" class="divider"></li>
									    <li><?php echo $this->Html->link(__('Remover'), ['action' => 'delete', $coleta->id], ['class'=>'delete-confirm','escape' => false]) ?></li>
									  </ul>
							</div>
						</td>
                                                <td data-title="id"><?php echo $this->Number->format($coleta->id) ?>&nbsp;</td>
                                                <td data-title="codigo"><?php echo h($coleta->codigo) ?>&nbsp;</td>
                                                <td data-title="descricao"><?php echo h($coleta->descricao) ?>&nbsp;</td>
                                                <td data-title="validate"><?php echo h($coleta->validate) ?>&nbsp;</td>
                                                <td data-title="lote"><?php echo h($coleta->lote) ?>&nbsp;</td>
                                                <td data-title="quantidade"><?php echo $this->Number->format($coleta->quantidade) ?>&nbsp;</td>
                                                 
                        <!-- 
                        <td>
                            <a href="#" class="btn btn-info btn-sm pull-right"  rel="popover" data-placement="left" data-popover-content="#myPopover<?php echo $coleta->id ?>" data-container="body" data-toggle="popover"> <span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a>
							<div id="myPopover<?php echo $coleta->id ?>" class="hide">
								  <?php echo $this->Html->link('<span class="glyphicon glyphicon-info-sign " aria-hidden="true"></span>', ['action' => 'view', $coleta->id], ['class'=>'btn btn-default', 'escape' => false]) ?>
                                   <?php echo $this->Html->link('<span class="glyphicon glyphicon-pencil " aria-hidden="true"></span>', ['action' => 'edit', $coleta->id], ['class'=>'btn btn-default','escape' => false]) ?>
                                  <?php echo $this->Html->link('<span class="glyphicon glyphicon-trash " aria-hidden="true"></span>', ['action' => 'delete', $coleta->id], ['class'=>'btn btn-danger delete-confirm','title'=>"Remover",'escape' => false]) ?>
							</div>
                        </td>
                         -->
                    </tr>
              ...
              <?php if($coletas->isEmpty()  && !empty($url) ):?>
