...
<div id="AjaxContent" class="documentos index large-9 medium-8 columns content"> 
...
'cols' => [
            ...
            <div class="panel-body">                
            	                <?php echo $this->Form->input('titulo',['label'=>'Título']) ?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <h3><?php echo __('Documentos') ?> <small>Listagem</small></h3>
        </div>
        ...
        <div id="PanelBody" >  
            ...
            <table class="table table-striped" cellpadding="0" cellspacing="0" style="margin: 0; padding: 0">
                <thead>
                    <tr>
                    	<th class="actions">&nbsp;</th>
                    							<th class="ajax-pagination"><?php echo $this->Paginator->sort('titulo','Título') ?></th>
                    							<th class="ajax-pagination"><?php echo $this->Paginator->sort('arquivo_nome','Arquivo') ?></th>
                                                <th class="ajax-pagination"><?php echo $this->Paginator->sort('ativo') ?></th>
                                                <th class="ajax-pagination"><?php echo $this->Paginator->sort('cadastro') ?></th>
                    ...
                    <tr <?php echo $class;?>>
                    		...
                    		<div class="btn-group ">
									 ...
									 <ul class="dropdown-menu ">
									    <li><?php echo $this->Html->link(__('Detalhes'), ['action' => 'view', $documento->id], ['escape' => false]); ?></li>
									    <li><?php echo $this->Html->link(__('Alterar'), ['action' => 'edit', $documento->id], ['escape' => false]); ?></li>
									   <li role="separator" class="divider"></li>
									   <li><?php echo $this->Html->link(__('Download'), ['action' => 'download', $documento->id], ['escape' => false]); ?></li>
									    <li role="separator" class="divider"></li>
									    <li><?php echo $this->Html->link(__('Remover'), ['action' => 'delete', $documento->id], ['class'=>'delete-confirm','escape' => false]) ?></li>
									  </ul>
							</div>
						</td>
                                		        ...
                                		        <td data-title="titulo"><?php echo h($documento->titulo) ?>&nbsp;</td>
                                		        <td data-title="titulo"><?php echo h($documento->arquivo_nome) ?>&nbsp;</td>
                                                <td data-title="ativo"><?php echo h($documento->ativo ? 'SIM' : 'NÃO') ?>&nbsp;</td>
                                                <td data-title="cadastro"><?php echo h($documento->cadastro) ?>&nbsp;</td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
              <?php if($documentos->isEmpty()  && !empty($url) ):?>
              <div class="panel-body">
