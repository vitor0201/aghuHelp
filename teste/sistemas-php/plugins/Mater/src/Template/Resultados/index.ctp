...
<div id="AjaxContent" class="resultados index large-9 medium-8 columns content"> 
<?php //echo date('d/m/Y H:i:s') ; ?>
        ...
        <div id="collapseOne" class="panel-collapse collapse ">
           ...
           // $this->Form->templates($CustomConfig['FormFilter.Template']);            
            ...
            <div class="panel-body">                
                                ...
                                <?php echo $this->Form->input('ativo',['label'=>'Ativo', 'options'=>[0=>'Inativo',1=>'Ativo'], 'empty'=>'Todos']) ?>
                            </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <h3><?php echo __('Resultados') ?> <small>Listagem</small></h3>
        </div>
        ...
        <div id="PanelBody" >  
            ...
            <table class="table table-striped" cellpadding="0" cellspacing="0" style="margin: 0; padding: 0">
                    ...
                    <tr <?php echo $class;?>>
                    		...
                    		<div class="btn-group ">
									 ...
									 <ul class="dropdown-menu ">
									    <li><?php echo $this->Html->link(__('Alterar'), ['action' => 'edit', $resultado->id], ['escape' => false]); ?></li>
									   
									    <li role="separator" class="divider"></li>
									    <li><?php echo $this->Html->link(__('Remover'), ['action' => 'delete', $resultado->id], ['class'=>'delete-confirm','escape' => false]) ?></li>
									  </ul>
							</div>
						</td>
                                                
                                                <td data-title="descricao"><?php echo h($resultado->descricao) ?>&nbsp;</td>
                                                <td data-title="ativo"><?php echo h($resultado->ativo? 'SIM' : 'NÃO') ?>&nbsp;</td>
                                                 
                        <!-- 
                        <td>
                            <a href="#" class="btn btn-info btn-sm pull-right"  rel="popover" data-placement="left" data-popover-content="#myPopover<?php echo $resultado->id ?>" data-container="body" data-toggle="popover"> <span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a>
							<div id="myPopover<?php echo $resultado->id ?>" class="hide">
								  <?php echo $this->Html->link('<span class="glyphicon glyphicon-info-sign " aria-hidden="true"></span>', ['action' => 'view', $resultado->id], ['class'=>'btn btn-default', 'escape' => false]) ?>
                                   <?php echo $this->Html->link('<span class="glyphicon glyphicon-pencil " aria-hidden="true"></span>', ['action' => 'edit', $resultado->id], ['class'=>'btn btn-default','escape' => false]) ?>
                                  <?php echo $this->Html->link('<span class="glyphicon glyphicon-trash " aria-hidden="true"></span>', ['action' => 'delete', $resultado->id], ['class'=>'btn btn-danger delete-confirm','title'=>"Remover",'escape' => false]) ?>
							</div>
                        </td>
                         -->
                    </tr>
              ...
              <?php if($resultados->isEmpty()  && !empty($url) ):?>
              <div class="panel-body">
