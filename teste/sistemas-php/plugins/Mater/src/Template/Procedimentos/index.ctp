...
<div id="AjaxContent" class="procedimentos index large-9 medium-8 columns content"> 
...
'cols' => [
            ...
            <div class="panel-body">                
                                <?php echo $this->Form->input('codigo',['label'=>'Código']) ?>
                                <?php echo $this->Form->input('descricao',['label'=>'Descrição']) ?>
                                  <?php echo $this->Form->input('sigla',['label'=>'Sigla']) ?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <h3><?php echo __('Procedimentos') ?> <small>Listagem</small></h3>
        </div>
                ...
                <thead>
                    <tr>
                    	<th class="actions">&nbsp;</th>
                                                ...
                                                <th class="ajax-pagination"><?php echo $this->Paginator->sort('codigo', 'Código') ?></th>
                                                <th class="ajax-pagination"><?php echo $this->Paginator->sort('descricao2','Descrição') ?></th>
                    ...
                    <tr <?php echo $class;?>>
                    		...
                    		<div class="btn-group ">
									 ...
									 <ul class="dropdown-menu ">
									    <li><?php echo $this->Html->link(__('Detalhes'), ['action' => 'view', $procedimento->id], ['escape' => false]); ?></li>
									    <li><?php echo $this->Html->link(__('Alterar'), ['action' => 'edit', $procedimento->id], ['escape' => false]); ?></li>
									   
									    <li role="separator" class="divider"></li>
									    <li><?php echo $this->Html->link(__('Remover'), ['action' => 'delete', $procedimento->id], ['class'=>'delete-confirm','escape' => false]) ?></li>
									  </ul>
							</div>
						</td>
                                            
                                                <td data-title="Código"><?php echo h($procedimento->codigo) ?>&nbsp;</td>
                                                <td data-title="Descrição"><?php echo h($procedimento->descricao2) ?>&nbsp;</td>
                                                <td data-title="Sigla"><?php echo h($procedimento->sigla) ?>&nbsp;</td>
                                                <td data-title="Ativo"><?php echo h($procedimento->ativo ? 'SIM': 'NÃO') ?>&nbsp;</td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
              <?php if($procedimentos->isEmpty()  && !empty($url) ):?>
              	<div class="panel-body">
