 ...
 *
 * @property \Mater\Model\Table\SituacoesTable $Situacoes
 */
class SituacoesController extends AppController
{
    ...
    public function index()
    {
		...
		$this->Filter->addFilter([
				'descricao'=> ['field'=> 'Situacoes.descricao', 'operator'=>'ILIKE'] ,
				'ativo'=> ['field'=> 'Situacoes.ativo', 'operator'=>'='] 
		]);
    	...
    	if(isset($this->request->query['export']) && $this->request->query['export']=='csv'){
    		...
    		$this->Export->CSV('Situacoes_'.date('d_m_Y_H_i_s').'.csv', $data_export, ['id','Descrição','Ativo'], $callback );
    	}
