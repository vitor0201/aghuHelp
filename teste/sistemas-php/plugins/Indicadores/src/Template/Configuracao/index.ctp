...
<div id="AjaxContent"
	class="configuracao index large-9 medium-8 columns content">
		...
		<div id="collapseOne" class="panel-collapse collapse ">
            ...
            <div class="panel-body">                
            	<?php echo $this->Form->input('filtro1') ?>
                                ...
                                <?php echo $this->Form->input('indicador_id') ?>
                            </div>
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			...
			<h3><?php echo __('Configuração') ?> <small>Listagem</small>
			</h3>
		</div>
				...
				<table class="table table-striped" cellpadding="0" cellspacing="0"
					...
					<thead>
						<tr>
							...
							<th class="ajax-pagination"><?php echo $this->Paginator->sort('valor') ?></th>
							<th class="ajax-pagination"><?php echo $this->Paginator->sort('indicador_id') ?></th>
							...
							<td class="action">
								...
								<div class="btn-group ">
									...
									<ul class="dropdown-menu ">
										<li><?php echo $this->Html->link(__('Detalhes'), ['action' => 'view', $configuracao->id], ['escape' => false]); ?></li>
										<li><?php echo $this->Html->link(__('Alterar'), ['action' => 'edit', $configuracao->id], ['escape' => false]); ?></li>

										<li role="separator" class="divider"></li>
										<li><?php echo $this->Html->link(__('Ativar/Desativar'), ['action' => 'delete', $configuracao->id], ['class'=>'delete-confirm','escape' => false]) ?></li>
									</ul>
								</div>
							</td>
							<td data-title="id"><?php echo $this->Number->format($configuracao->id) ?>&nbsp;</td>
							<td data-title="data"><?php echo h($configuracao->data) ?>&nbsp;</td>
							<td data-title="valor"><?php echo $this->Number->format($configuracao->valor) ?>&nbsp;</td>
							<td data-title="indicador_id"><?php echo ($configuracao->indicador->nome) ?>&nbsp;</td>
							<td><?= $configuracao->ativo ? $this->Html->label('ATIVO','info') :  $this->Html->label('INATIVO','danger');  ?>

							<!-- 
                        <td>
                            <a href="#" class="btn btn-info btn-sm pull-right"  rel="popover" data-placement="left" data-popover-content="#myPopover<?php echo $configuracao->id ?>" data-container="body" data-toggle="popover"> <span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a>
							<div id="myPopover<?php echo $configuracao->id ?>" class="hide">
								  <?php echo $this->Html->link('<span class="glyphicon glyphicon-info-sign " aria-hidden="true"></span>', ['action' => 'view', $configuracao->id], ['class'=>'btn btn-default', 'escape' => false]) ?>
                                   <?php echo $this->Html->link('<span class="glyphicon glyphicon-pencil " aria-hidden="true"></span>', ['action' => 'edit', $configuracao->id], ['class'=>'btn btn-default','escape' => false]) ?>
                                  <?php echo $this->Html->link('<span class="glyphicon glyphicon-trash " aria-hidden="true"></span>', ['action' => 'delete', $configuracao->id], ['class'=>'btn btn-danger delete-confirm','title'=>"Remover",'escape' => false]) ?>
