...
<div id="AjaxContent"
	class="tipoPendencias index large-9 medium-8 columns content"> 
<?php //echo date('d/m/Y H:i:s') ; ?>
    <div class="panel panel-default" id="panel1">
		...
		<div id="collapseOne" class="panel-collapse collapse ">
            ...
            <div class="panel-body">                
                                ...
                                <?php echo $this->Form->input('ativo',['label'=> 'Ativo'])?>
                            </div>
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			...
			<h3><?php echo __('Tipo Pendências') ?> <small>Listagem</small>
			</h3>
		</div>
			...
			<div id="PanelBody">
				...
				<table class="table table-striped" cellpadding="0" cellspacing="0"
					...
					<thead>
						<tr>
							<th class="actions">&nbsp;</th>
							<th class="ajax-pagination"><?php echo $this->Paginator->sort('descricao',['label'=>'Descrição']) ?></th>
							<th class="ajax-pagination"><?php echo $this->Paginator->sort('ativo',['label'=>'Ativo']) ?></th>
                    ...
                    <?php
                    $i = 0;
                    foreach ($tipoPendencias as $tipoPendencia) :
                        $class = "";
                        // if(!$tipoPendencia->ativo)
							...
							<td class="action">
								...
								<div class="btn-group ">
									...
									<ul class="dropdown-menu ">
										<li><?php echo $this->Html->link(__('Detalhes'), ['action' => 'view', $tipoPendencia->id], ['escape' => false]); ?></li>
										<li><?php echo $this->Html->link(__('Alterar'), ['action' => 'edit', $tipoPendencia->id], ['escape' => false]); ?></li>

								
									</ul>
								</div>
							</td>
							<td data-title="descricao"><?php echo h($tipoPendencia->descricao) ?>&nbsp;</td>
							<td data-title="ativo"><?php echo $tipoPendencia->ativo? $this->Html->label('ATIVO','info') :  $this->Html->label('INATIVO','danger');?>&nbsp;</td>

							<!-- 
                        <td>
                            <a href="#" class="btn btn-info btn-sm pull-right"  rel="popover" data-placement="left" data-popover-content="#myPopover<?php echo $tipoPendencia->id ?>" data-container="body" data-toggle="popover"> <span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a>
							<div id="myPopover<?php echo $tipoPendencia->id ?>" class="hide">
								  <?php echo $this->Html->link('<span class="glyphicon glyphicon-info-sign " aria-hidden="true"></span>', ['action' => 'view', $tipoPendencia->id], ['class'=>'btn btn-default', 'escape' => false])?>
                                   <?php echo $this->Html->link('<span class="glyphicon glyphicon-pencil " aria-hidden="true"></span>', ['action' => 'edit', $tipoPendencia->id], ['class'=>'btn btn-default','escape' => false])?>
                                  <?php echo $this->Html->link('<span class="glyphicon glyphicon-trash " aria-hidden="true"></span>', ['action' => 'delete', $tipoPendencia->id], ['class'=>'btn btn-danger delete-confirm','title'=>"Remover",'escape' => false])?>
							</div>
                        </td>
                         -->
						</tr>
              ...
              <?php if($tipoPendencias->isEmpty()  && !empty($url) ):?>
