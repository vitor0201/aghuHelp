...
<div id="AjaxContent"
                ...
                jQuery("#FormFilterSubmit").click(
                        ...
                        {                
                            jQuery.ajax({
                                ...
                                async: true,
                                cache: false,
                                url: '<?php echo $this->Url->build([ "action" => "rotatividade"]);?>',
	...
	<div class="criterios view large-9 medium-8 columns content">
			...
			<div class="panel-heading">
				...
				<div class=" pull-right">
					<button class="btn btn-sm" type="button" aria-haspopup="true"
						aria-expanded="true">
						<?php echo $this->Html->link('<span class="glyphicon glyphicon-question-sign pull-right" aria-hidden="true"></span>&nbsp; ', ['controller' => 'FichaIndicadores', 'action' => 'view', 25], ['escape' => false]) ?>
					</button>
				</div>

				<h3>Íindice de Renovação/ Giro de Rotatividade</h3>
			</div>
			<div class="panel-body">
      ...
      function drawChart() {
        ...
        data.addColumn('number', 'Rotatividade');
