            			...
            			<!-- OPÇÕES -->
                          ...
                          $('#dataSaida').datetimepicker({     
                              ...
                              maxDate: new Date() 
                                ...
                                <?php echo $this->Form->input('especialidade_id',['label'=>'Especialidades','options'=>$especialidades_list, 'class'=>'select2', 'multiple'=>'multiple', 'style'=>'width:100%'])?>
                ...
                jQuery("#FormFilterSubmit").click(
                        ...
                        {                
                            jQuery.ajax({
                                ...
                                async: true,
                                cache: false,
                                url: '<?php echo $this->Url->build([ "action" => "especialidade"]);?>',
      ...
      function drawChart() {
        ...
        data.addRows([
        		<?php 
        				...
        				{
        					echo "['" . $especialidade['Especialidades']['nome_especialidade'] . " - " . $especialidade['Total']. 
        							"',". $especialidade['Total']."],";
        				}
        		?>
        ]);
        ...
        // Set chart options
        var options = {'title':'Especialidades por Unidades',
                       'pieSliceText':'value',  
                       'width':1000,
                       'height':600,
